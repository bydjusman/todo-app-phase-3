...
def test_chatbot_with_api_key():
    """Test the chatbot with the provided Google API key"""
    print("Testing chatbot with Google API key...")
    ...
    if chat_response.status_code == 200:
        ...
        if list_response.status_code == 200:
            ...
            return True  # Still return True as the first request worked
    else:
...
if __name__ == "__main__":
    success = test_chatbot_with_api_key()
    if success:
        print("\nChatbot test with Google API key PASSED!")
    else:
        print("\nChatbot test with Google API key FAILED!")